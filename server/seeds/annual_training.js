...
exports.seed = async function(knex) {
  ...
  await knex('annual_training').insert([
    ...
    {training_name: 'Cyber_Awareness', training_date:'1999-05-30',users_id:3},
    {training_name: 'Sharp_Training', training_date:'2020-08-17',users_id:3},
    {training_name: 'DLC1', training_date:'2021-09-27',users_id:3}
  ]);
};
